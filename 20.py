    ...
    try:
        ...
        if op.type == 11:
            if op.param1 in protectqr:
                ...
                try:
                    ...
                    try:
                        if kw.getGroup(op.param1).preventedJoinByTicket == False:
                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                kw.reissueGroupTicket(op.param1)
                        ...
                        try:
                            ...
                            try:
                                if ky.getGroup(op.param1).preventedJoinByTicket == False:
                                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                        ky.reissueGroupTicket(op.param1)
                                ...
                                try:
                                    ...
                                    try:
                                        if k19.getGroup(op.param1).preventedJoinByTicket == False:
                                            if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                                k19.reissueGroupTicket(op.param1)
                                        ...
                                        try:
                                            if k18.getGroup(op.param1).preventedJoinByTicket == False:
                                                if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                                    k18.reissueGroupTicket(op.param1)
        ...
        if op.type == 11:
            if op.param1 in protectqr:
                wait["blacklist"][op.param2] = True
                try:
                    if k17.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            k17.reissueGroupTicket(op.param1)
        ...
        if op.type == 19:
            try:
                ...
                if op.param3 in Emid:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        k20.kickoutFromGroup(op.param1,[op.param2])
                        k20.findAndAddContactsByMid(op.param3)
                        k20.inviteIntoGroup(op.param1,[Emid])
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        kk.kickoutFromGroup(op.param1,[op.param2])
                                        kk.inviteIntoGroup(op.param1,[op.param3])                                        
                                        ki.kk.inviteIntoGroup(op.param1,[op.param3])
                                        ki.acceptGroupInvitation(op.param1)                                        
                                    except:
                                        try:
                                            kc.kickoutFromGroup(op.param1,[op.param2])
                        ...
                        try:
                            ...
                            try:
                                ...
                                try:
                                    ...
                                    k16.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    k17.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    k18.accepttGroupInvitationByTicket(op.param1,Ticket)
                                    k19.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    k20.acceptGroupInvitationByTicket(op.param1,Ticket)
                                    G = kb.getGroup(op.param1)
                                    G.preventedJoinByTicket = True
        ...
        if op.type == 22:
            if settings['leaveRoom'] == True:
                ...
                kn.leaveRoom(op.param1)
                ko.leaveRoom(op.param1)
                kw.leaveRoom(op.param1)
                ke.leaveRoom(op.param1)
                ky.leaveRoom(op.param1)
                k11.leaveRoom(op.param1)
                k12.leaveRoom(op.param1)
                k13.leaveRoom(op.param1)
                k14.leaveRoom(op.param1)
                k15.leaveRoom(op.param1)
                k16.leaveRoom(op.param1)
                k17.leaveRoom(op.param1)
                k18.leaveRoom(op.param1)
                k19.leaveRoom(op.param1)
                k20.leaveRoom(op.param1)                
        if op.type == 24:
            if settings['leaveRoom'] == True:
                cl.leaveRoom(op.param1)
                ki.leaveRoom(op.param1)
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               kc.sendMessage(msg.to,"➲ 3 อยู่ครับเจ้านาย")
                               km.sendMessage(msg.to,"➲ 4 อยู่ครับเจ้านาย")
                               kb.sendMessage(msg.to,"➲ 5 อยู่ครับเจ้านาย")
                               kn.sendMessage(msg.to,"➲ 6 อยู่ครับเจ้านาย")
                               ko.sendMessage(msg.to,"➲ 7 อยู่ครับเจ้านาย")
                               kw.sendMessage(msg.to,"➲ 8 อยู่ครับเจ้านาย")
                               ke.sendMessage(msg.to,"➲ 9 อยู่ครับเจ้านาย")
                               ky.sendMessage(msg.to,"➲ 10 อยู่ครับเจ้านาย")
                               k11.sendMessage(msg.to,"➲ 11 อยู่ครับเจ้านาย")
                               k12.sendMessage(msg.to,"➲ 12 อยู่ครับเจ้านาย")
                               k13.sendMessage(msg.to,"➲ 13 อยู่ครับเจ้านาย")
                               k14.sendMessage(msg.to,"➲ 14 อยู่ครับเจ้านาย")
                               k15.sendMessage(msg.to,"➲ 15 อยู่ครับเจ้านาย")
                               k16.sendMessage(msg.to,"➲ 16 อยู่ครับเจ้านาย")                                
                               k17.sendMessage(msg.to,"➲ 17 อยู่ครับเจ้านาย")
                               k18.sendMessage(msg.to,"➲ 18 อยู่ครับเจ้านาย")
                               k19.sendMessage(msg.to,"➲ 19 อยู่ครับเจ้านาย")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "ความเร็วอยุ่ที่")
...
#===========ADMIN ADD============#
                        ...
                        elif cmd == "refresh" or text.lower() == 'รี':
                            if msg._from in admin:
                                wait["addadmin"] = False
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               try:kn.inviteIntoGroup(to, ["u45882d0ead1703855dbc60d40e37bec7"]);has = "OK"
                               except:has = "NOT"
                               try:kn.kickoutFromGroup(to, ["u45882d0ead1703855dbc60d40e37bec7"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ko.inviteIntoGroup(to, ["u2bf37dc8bb9ac850615395a9e15850f9"]);has = "OK"
                               except:has = "NOT"
                               try:ko.kickoutFromGroup(to, ["u2bf37dc8bb9ac850615395a9e15850f9"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kw.inviteIntoGroup(to, ["u0a5ee8d796e3677a56b84ff03b6564ec"]);has = "OK"
                               except:has = "NOT"
                               try:kw.kickoutFromGroup(to, ["u0a5ee8d796e3677a56b84ff03b6564ec"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ke.inviteIntoGroup(to, ["u29b16f0e99cfdf0e7d7b8170f7cdc1a7"]);has = "OK"
                               except:has = "NOT"
                               try:ke.kickoutFromGroup(to, ["u29b16f0e99cfdf0e7d7b8170f7cdc1a7"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ky.inviteIntoGroup(to, ["udfad8056476f3e76903575513cc8aebe"]);has = "OK"
                               except:has = "NOT"
                               try:ky.kickoutFromGroup(to, ["udfad8056476f3e76903575513cc8aebe"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k11.inviteIntoGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has = "OK"
                               except:has = "NOT"
                               try:k11.kickoutFromGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k12.inviteIntoGroup(to, ["u45882d0ead1703855dbc60d40e37bec7"]);has = "OK"
                               except:has = "NOT"
                               try:k12.kickoutFromGroup(to, ["u45882d0ead1703855dbc60d40e37bec7"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k13.inviteIntoGroup(to, ["u2bf37dc8bb9ac850615395a9e15850f9"]);has = "OK"
                               except:has = "NOT"
                               try:k13.kickoutFromGroup(to, ["u2bf37dc8bb9ac850615395a9e15850f9"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k14.inviteIntoGroup(to, ["u0a5ee8d796e3677a56b84ff03b6564ec"]);has = "OK"
                               except:has = "NOT"
                               try:k14.kickoutFromGroup(to, ["u0a5ee8d796e3677a56b84ff03b6564ec"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k15.inviteIntoGroup(to, ["u29b16f0e99cfdf0e7d7b8170f7cdc1a7"]);has = "OK"
                               except:has = "NOT"
                               try:k15.kickoutFromGroup(to, ["u29b16f0e99cfdf0e7d7b8170f7cdc1a7"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k16.inviteIntoGroup(to, ["udfad8056476f3e76903575513cc8aebe"]);has = "OK"
                               except:has = "NOT"
                               try:k16.kickoutFromGroup(to, ["udfad8056476f3e76903575513cc8aebe"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k17.inviteIntoGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has = "OK"
                               except:has = "NOT"
                               try:k17.kickoutFromGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k18.inviteIntoGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has = "OK" 
                               except:has1 = "NOT"
                               try:k18.kickoutFromGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has1 = "OK"                     
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               else:sil1 = "🔌█▒ Low 0%" 
                               k18.sendMessage(to, "Status:\n\n🔴Kick : {} \n🔴Invite : {}".format(sil1,sil))
                               try:k19.inviteIntoGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has = "OK" 
                               except:has = "NOT"
                               try:k19.kickoutFromGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:k20.inviteIntoGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has = "OK"  
                               except:has = "NOT"                     
                               try:k20.kickoutFromGroup(to, ["uea5fe04e39713e6768cf5687bc5ac7aa"]);has1 = "OK"
                               except:has1 = "NOT"                     
                               if has == "OK":sil = "🔋██ full 100%"                     
                               else:sil = "🔌█▒ Low 0%"                     
                               if has1 == "OK":sil1 = "🔋██ full 100%"                     
