                            ...
                            try:
                                if ky.getGroup(op.param1).preventedJoinByTicket == False:
                                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                                        ...
                                        k20.acceptGroupInvitationByTicket(op.param1,Ticket)                                        k20.kickoutFromGroup(op.param1,[op.param2])                                      
                                        ky.updateGroup(X)
                            except:
                                try:
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "เปิดบอท":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "เปิดระบบทำงานของบอทแล้วคัฟเจ้านาย")
                                
                        elif cmd == "ปิดบอท":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "ปิดระบบทำงานของบอทแล้วคัฟเจ้านาย")
...
#===========COMMAND SET============#
                           ...
                           if msg._from in admin:
                            ...
                            if msg._from in admin or msg._from in owner:
                               ...
                               try:km.inviteIntoGroup(to, ["u21f2166935c999fe450ce5ea5aa42652"]);has = "OK"
                               except:has = "NOT"
                               try:km.kickoutFromGroup(to, ["u21f2166935c999fe450ce5ea5aa42652"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kb.inviteIntoGroup(to, ["u2739569d28dfd03972f92bc4508d5b95"]);has = "OK"
                               except:has = "NOT"
                               try:kb.kickoutFromGroup(to, ["u2739569d28dfd03972f92bc4508d5b95"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kn.inviteIntoGroup(to, ["ue093b1293a087794a6750a77b5ec3990"]);has = "OK"
                               except:has = "NOT"
                               try:kn.kickoutFromGroup(to, ["ue093b1293a087794a6750a77b5ec3990"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ko.inviteIntoGroup(to, ["u6756e5a6ec421fbe85b3173d2c32a16a"]);has = "OK"
                               except:has = "NOT"
                               try:ko.kickoutFromGroup(to, ["u6756e5a6ec421fbe85b3173d2c32a16a"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:kw.inviteIntoGroup(to, ["ua747585a5201be67956b55bcfe662466"]);has = "OK"
                               except:has = "NOT"
                               try:kw.kickoutFromGroup(to, ["ua747585a5201be67956b55bcfe662466"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ke.inviteIntoGroup(to, ["u252bef6cbe92d5682068c6b07a3659db"]);has = "OK"
                               except:has = "NOT"
                               try:ke.kickoutFromGroup(to, ["u252bef6cbe92d5682068c6b07a3659db"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒. Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
                               ...
                               try:ky.inviteIntoGroup(to, ["u971c92c69915f75f6d427d580b8ee7a2"]);has = "OK"
                               except:has = "NOT"
                               try:ky.kickoutFromGroup(to, ["u971c92c69915f75f6d427d580b8ee7a2"]);has1 = "OK"
                               except:has1 = "NOT"
                               if has == "OK":sil = "🔋██ full 100%"
                               else:sil = "🔌█▒ Low 0%"
                               if has1 == "OK":sil1 = "🔋██ full 100%"
